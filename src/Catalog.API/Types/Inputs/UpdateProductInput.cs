...
public record UpdateProductInput(
    ...
    [property: DefaultValue("UHJvZHVjdFR5cGU6Mg==")][property: ID<ProductType>] Optional<int> TypeId,
    [property: DefaultValue("QnJhbmQ6MTQ=")][property: ID<Brand>] Optional<int> BrandId,
